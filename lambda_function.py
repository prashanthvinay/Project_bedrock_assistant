...
def lambda_handler(event, context):
    ...
    system_prompt = [
            {
                "text": "Act as an Amazon Bedrock SME assistant. Answer the question in 2 to 5 sentences logically only if it is related to Amazon Bedrock service. Else, reject answering the question politely."
            }
]
